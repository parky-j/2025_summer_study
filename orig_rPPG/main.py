...
def main():
    # Initialize modules
    cap = cv2.VideoCapture('C:/Users/user/Documents/dataset/DROZY/DROZY/videos_i8/1-1.mp4')
    detector = Detector()
    rppg = rPPG()
    rrsp = rRSP('C:/Users/user/Documents/orig_rPPG/orig_rPPG/model/onnx_model.onnx')
...
# def main():
#     # === 설정 ===
#     video_root = "C:/Users/user/Documents/dataset/DROZY/DROZY/videos_i8"
